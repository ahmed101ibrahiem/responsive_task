...
import 'package:responsive_task/view/screens/responsible.dart';
    ...
    return Scaffold(
      ...
      body: ListView(
          ...
          children: [
            SizedBox(
              height:
                  isportrait ? context.height * 0.01 : context.height * 0.03,
            ),
            CarouselSlider(
                items: urlList
                    .map((item) => ClipRRect(
            ...
            SizedBox(
                height:
                    isportrait ? context.height * 0.02 : context.height * 0.04),
            GridView(
                shrinkWrap: true,
                padding:
                    isportrait ? EdgeInsets.all(16.h) : EdgeInsets.all(2.w),
